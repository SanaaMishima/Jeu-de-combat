...
class Bouser(Perso): #Personnage d'attaque ayant beaucoup de vie, fait beaucoup de dégâts, peut brûler, mais peu de défense
...
class Hoshi(Perso): #Personnage troll ayant une chance sur deux d'éviter tous les dégâts mais inutile pour l'attaque
